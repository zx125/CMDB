    ...
    $.extend($.fn.modal.Constructor.prototype, {
        ...
        preloadImages: function () {
            var options = this.options,
                range = options.index_bak + options.preloadRange + 1,
                link,
                i;
            for (i = options.index_bak - options.preloadRange; i < range; i += 1) {
                link = this.$links[i];
                if (link && i !== options.index_bak) {
